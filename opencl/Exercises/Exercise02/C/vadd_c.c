...
int main(int argc, char** argv)
{
    ...
    float*       h_a = (float*) calloc(x, sizeof(float));       // a vector
    float*       h_b = (float*) calloc(x, sizeof(float));       // b vector
    float*       h_c = (float*) calloc(x, sizeof(float));       // c vector (a+b) returned from the compute device
